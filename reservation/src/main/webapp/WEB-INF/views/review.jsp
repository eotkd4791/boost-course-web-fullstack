                        ...
                        <div class="short_review_area">
                            <div class="grade_area"> 
                            	<span class="graph_mask"> 
                            		<em class="graph_value" style="width: ${productDetail.averageScore / 5 * 100}%;"></em> 
                           		</span> 
                           		<strong class="text_value"> 
	                           		<span>${productDetail.averageScore }</span> 
	                           		<em class="total">5.0</em> 
                           		</strong> 
                          		<span class="join_count">
                          			<em class="green">${productDetail.comments.size()}건</em> 
                          			등록
                         		</span>                                
                         	</div>
                            <ul class="list_short_review">
	                            <c:forEach var="comment" items="${productDetail.comments}" varStatus="status">
	                            	<li class="list_item">
	                                    <div>
	                                        ...
	                                        <div class="info_area">
	                                            <div class="review_info"> 
	                                            	...
	                                            	<span class="date">${comment.reservationDate.year}.${comment.reservationDate.monthValue}.${comment.reservationDate.dayOfMonth} 방문</span> 
	                                           	</div>
	                                        </div>
	                                    </div>
	                                </li>
	    	    ...
	    	    <div class="review_area">
	        	    <div class="thumb_area">
	            	    <a href="#" class="thumb" title="이미지 크게 보기">
							<img width="90" height="90" class="img_vertical_top" src="{commentImage}" alt="리뷰이미지" style="display: {display}"> 
						</a> 
