		...
		<div class="ct">
			...
			<div class="ct_wrap">
				<div class="top_title review_header">
					<a href="./comment" class="btn_back" title="이전 화면으로 이동"> <i class="fn fn-backward1"></i> </a>
				...
				<div class="review_contents write">
					...
					<textarea cols="30" rows="10" minlength="5" maxlength="40" class="review_textarea"></textarea>
				</div>
				<!-- //리뷰 입력 -->
				...
				<div class="review_write_footer_wrap">
					<div class="review_write_footer">
						...
						<input type="file" name="attachedImage" class="hidden_input" id="reviewImageFileOpenInput" accept="image/*.png, image/*.jpeg">
