                  ...
                  <div >
                     <form name="confirm_form" class="ng-pristine ng-valid" id="form1" action="./bookinglogin" method="post">
                        ...
                        <div class="login_form"> 
                           <label class="label_form" for="reservationEmail" translate="CM-BOOKING_NUMBER">예약자 이메일 입력</label> 
                           <input type="email" class="login_input ng-pristine ng-untouched ng-valid ng-empty" id="reservationEmail" name="reservationEmail" aria-invalid="false" placeholder="crong@naver.com" title="예매자이메일" required pattern="[a-z0-9]+@[a-z0-9]+[a-z0-9.]+">  </div>
